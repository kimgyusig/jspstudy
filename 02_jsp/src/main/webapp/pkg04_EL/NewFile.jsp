...
<body>
  ...
  <%--
    ...
    1. 속성(Attribute)
       ...
       ${number}, 숫자 타입    10 -5 : true   10 -5 >0 : true
    
    2. 파라미터(Parameter)
       resquest.sendRedirect("contextPath/URLMapping?number=10");
       ${param.number}, 문자열 타입  "10" - 5 : false   "10" -5 > 0 : true 자동형변환
